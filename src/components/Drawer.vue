<script setup>
    ...
    const createOrder = async () => {
        try {
            ...
            const { data } = await axios.post('https://dde72bb127b34a84.mokky.dev/orders', {
                items: cart.value,
        ...
        <div v-else>
            ...
            <div class="flex flex-col gap-4 mt-7">
                ...
                <button 
                    ...
                    @click="createOrder" 
                    class="mt-4 transition bg-lime-500 w-full rounded-xl py-3 text-white disabled:bg-slate-300 hover:bg-lime-600 active:bg-lime-700">
                        Оформить заказ
                </button>
            </div>
        </div>
